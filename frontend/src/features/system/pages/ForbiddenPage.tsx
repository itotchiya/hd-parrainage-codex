    ...
    <main className="flex min-h-screen items-center justify-center px-6 py-12">
      <section className="w-full max-w-3xl rounded-[2rem] border border-border bg-card/90 p-8 shadow-sm backdrop-blur">
        <p className="text-xs font-semibold uppercase tracking-[0.28em] text-rose-700">
          {t('system.forbidden.eyebrow')}
        </p>
        <h1 className="app-dialog-title mt-4">{t('system.forbidden.title')}</h1>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          >
            {t('system.forbidden.backToDashboard')}
          </Link>
          <Link
            to="/login"
          ...
          >
            {t('system.forbidden.switchSession')}
          </Link>
        </div>
      </section>
    </main>
