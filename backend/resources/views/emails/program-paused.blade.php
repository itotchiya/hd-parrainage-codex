...
<html lang="en">
  <body style="font-family: Arial, sans-serif; color: #111827; line-height: 1.6;">
    <h1 style="font-size: 20px; margin-bottom: 12px;">A program you are assigned to has been paused</h1>
    ...
    <p style="margin: 0 0 16px;">
      The business owner paused this program. Referral activity for this program may be on hold until it is resumed.
    </p>
    <p style="margin: 0;">
