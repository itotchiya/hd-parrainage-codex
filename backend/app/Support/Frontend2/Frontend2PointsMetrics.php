...
namespace App\Support\Frontend2;

// Frontend2-only support class. Keep prototype wallet math isolated from the original frontend points engine.

use App\Models\ExchangeRequest;
use App\Models\PointsLedger;
use Illuminate\Support\Collection;

class Frontend2PointsMetrics
{
    /**
